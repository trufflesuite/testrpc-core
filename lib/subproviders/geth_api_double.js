...
GethApiDouble.prototype.personal_sign = function(dataToSign, address, password, callback) {
  var result;
  var error;

  try {
    result = this.state.personal_sign(address, dataToSign);
  } catch (e) {
    error = e;
  }
...
GethApiDouble.prototype.personal_ecRecover = function(dataThatWasSigned, signature, callback) {
  var result;
  var error;

  try {
    result = this.state.personal_ecRecover(dataThatWasSigned, signature);
  } catch (e) {
    error = e;
  }
